...
* Plugins are ordered by `(priority ASC, plugin_instance_gts_id ASC)`.
...
* Bad, because imports, source replacement, disaster recovery, and multi-DC operation must preserve and reconcile the index.
